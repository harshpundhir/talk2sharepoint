...
'''
'''
Office365-REST-Python-Client==2.4.3 new: 2.5.7

"C:\ACE_Project\ACT_Code\sharepoint_talktoDB\myvenv\Lib\site-packages\environ.py", 
line 114, 180, 105
chnaged
'''
import office365
...
sh = SharePoint()
print(sh.get_folder_list('General'), type(sh.get_folder_list('General')))